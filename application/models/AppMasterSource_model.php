<?php
class AppMasterSource_model extends MY_Model
{

    public function All()
    {
        $this->db->select('app_tbl_source.*');
        $this->db->from('app_tbl_source');
    ...
    {
        $this->db->insert('app_tbl_source', $data);
    ...
    {
        $this->db->where('id', $id);
        $this->db->update('app_tbl_source', $data);

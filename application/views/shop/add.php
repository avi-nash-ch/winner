...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="form-group row main_location">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="street_address" class="form-control" id="pac-input"
                            placeholder="&nbsp">
                        <div id="map"></div>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCheqXXLZiGbGYObQTX6HkOTjDklpBPCw0&callback=initAutocomplete&libraries=places&v=weekly"
        defer></script>

<?php $this->load->view('frontend/partial/header')?>
    ...
    <ul>
                    ...
                    <li class="cms_page">
                            <strong>School Bookstore - Customer Feedback</strong>
                                    </li>
            </ul>
</div>
                <div class="col-main">
...
<div class="std"><h2 align="center" style="text-align: left;">want to share your Feedback at&nbsp;<strong>Shop@ruchibooks.com</strong></h2></div>                 </div>
            </div>
        </div>
...
<div class="group-select"><form id="shippingzone-form" method="post" action="https://mybookshop.co.in/myshop/deliveryzone/index/index/uenc/aHR0cHM6Ly9teWJvb2tzaG9wLmNvLmluL215c2hvcC9mZWVkYmFjay1mb3Jt/">
...
<!-- Mirrored from mybookshop.co.in/myshop/feedback-form by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Dec 2022 17:38:34 GMT -->
</html>

      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
          <div class=product-images>
            <main id=gallery>
              ...
              <div class=images>
                <img src="<?= base_url('uploads/sellitems/') . $data['image1'] ?>" onclick="set_img('<?= $data['image1'] ?>')">
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <div class=product-info>
            <h2 class=title><?= $data['title'] ?>: <span> ₹<?= number_format($data['price']) ?></span></h2>
        ...
        <div class=row>
          <div class="col-lg-6 col-12">
            <div class="info-body custom-responsive-margin">
              ...
              <p><b>Contact : </b> <?= $data['seller_phone'] ?></p>
              <p><b>Village : </b> <?= $data['seller_village'] ?></p>
              <p><b>Taluka : </b> <?= $data['seller_taluka'] ?></p>
              <p><b>District : </b> <?= $data['seller_district'] ?></p>
              <p><b>State : </b> <?= $data['state_name'] ?></p>
              <p><b>Pincode : </b> <?= $data['seller_pincode'] ?></p>
            </div>
          </div>

        ...
        <div class="col-lg-3 col-12">
          ...
          <div class=product-sidebar>
            ...
            <div class=single-widget>
              ...
              <ul class=list>
                <li>
                  <a href="transportservice.html">Pune</a></span>
                </li>
                <li>
                  <a href="transportservice.html">Beed</a></span>
                </li>
                <li>
                  <a href="transportservice.html"> Thane</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Jalgaon</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Barshi</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Ahmednagar</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Parbhani</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Kolhapur</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Jalna</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Raigad</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Gondia</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Satara</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Solapur</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Yavatmal</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Amravati</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Osmanabad </a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Nandurbar</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Wardha</a><span></span>
                </li>
                <li>
                  <a href="transportservice.html">Latur</a><span></span>
                </li>

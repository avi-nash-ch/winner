            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header px-4 py-5">
                        <h5 class="text-muted mb-0"> Your Orders
                            <!-- , <span style="color: #a8729a;"><?= $this->session->name?></span>! -->
                        </h5>
                    </div>
                        ...
                        <div class="card shadow-0 border mb-4">
                            <div class="card-body">
                                ...
                                <hr class="mb-4" style="background-color: #e0e0e0; opacity: 1;">
                                    <div class="col-md-2">
                                        <img src="<?= base_url('uploads/images/') . $product->image ?>" class="img-fluid" alt="Phone">
                                    </div>
                                    <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0"><?= $product->product_name ?></p>
                                    </div>
                                    <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0 small">Color: <?= getColorNameByNumber($product->color) ?></p>
                                    </div>
                                    <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0 small">Size: <?= getSizeNameByNumber($product->size) ?></p>
                                    </div>
                                    <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0 small">Qty: <?= $product->quantity ?></p>
                                    </div>
                                    <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                        <p class="text-muted mb-0 small">₹<?= $product->cost ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>

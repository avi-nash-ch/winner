                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('backend/Products/OrderedView/' . $product->id) ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="View"><span class="fa fa-eye"></span></a>
                                </td>
                            </tr>
                        <?php }
                        ?>

...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <?php
                echo form_open_multipart('backend/Products/update', [
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="text" name="name" value="<?= $Product->name ?>" required id="name">
                    </div>
                    <div class="col-md-2">
                        <label for="qty">Qty. *</label>
                        <input class="form-control" type="number" Placeholder="Price" value="<?= $Product->qty ?>" name="qty" required id="prcie">
                    </div>
                    <div class="col-md-3">
                        <label for="price">Purchase Price Per Piece *</label>
                        <input class="form-control" type="text" Placeholder="Price" value="<?= $Product->purchase_price ?>" name="purchase_price" required id="prcie">
                    </div>
                    <div class="col-md-3">
                        <label for="price">Sale Price Per Piece *</label>
                        <input class="form-control" type="text" Placeholder="Price" value="<?= $Product->price_sale ?>" name="sale_price" required id="prcie">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="text" Placeholder="ISBN/Product Code" value="<?= $Product->product_code ?>" name="product_code" ] id="product_code">
                    </div>

                    <div class="col-md-3">
                        <label for="discount">Discount in %</label>
                        <input class="form-control" type="text" Placeholder="discount" value="<?= $Product->offer ?>" name="discount" id="discount">
                    </div>
                </div>

...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <?php
                    echo form_open_multipart('backend/Products/insert', ['autocomplete' => false, 'id' => 'add_product' ,'method'=>'post'], ['type' => $this->url_encrypt->encode('tbl_product')]);
                ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="text" Placeholder="discount" name="discount" id="discount">
                    </div>
                </div>

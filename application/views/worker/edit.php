            ...
            echo form_open_multipart('backend/Workers/update', ['autocomplete' => false, 'id' => 'edit_worker'
                ...
                <div class="form-group row">
                   ...
                   <?php } ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control" type="text" Placeholder="Name" value="<?= $Product->name?>"
                            name="name" required id="name">
                    </div>
                    <div class="col-md-3">
                        <label for="whatsapp_no">Whatsapp No.</label>
                        <input class="form-control" type="text" Placeholder="Whatsapp No."
                            value="<?= $Product->whatsapp_no?>" name="whatsapp_no" id="whatsapp_no">
                    </div>
                    <!-- <div class="col-md-3">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" Placeholder="Address" value="<?= $Product->address ?>"
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <input type="radio" name="delivery_boy_type" value="1"
                            <?= ($Product->delivery_boy_type==1)?'checked':'' ?>>
                        <br>
                        <label for="service_provider">Bike ID</label>
                        <input type="radio" name="delivery_boy_type" value="0"
                            <?= ($Product->delivery_boy_type==0)?'checked':'' ?>>
                    </div>
                </div>
                <div class="form-group row">

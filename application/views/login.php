...
<body style="background-image: url('<?= base_url('assets/images/sp_bg.png') ?>');">
    <div class="home-btn d-none d-sm-block"><a href="<?= base_url() ?>" class="text-dark"><i class="fas fa-home h2"></i></a>
    </div>
    <div class="wrapper-page">
        <div class="card overflow-hidden account-card mx-3">
            <div class=" p-4 text-white text-center position-relative" style="background:#000000;">
                <!-- <h4 class="font-20 m-b-5">Welcome Back !</h4> -->
                <p class="mb-4" style="color: #f7c5c5a1 !important;">Sign in to continue to <?= PROJECT_NAME ?>.</p>
                <a href="#" class="logo logo-admin">
                    <!-- <img src="<?= base_url(LOGO . $Setting->logo) ?>" height="80"
                        alt="logo"> -->
                </a>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="m-t-40 text-center">
                            ...
                            <p>© <?= date("Y") ?> NextGen Crafted with <i class="mdi mdi-heart" style="color: #ffc107!important;"></i></p>
                        </div>
                    </div>
                </div>
            </div>
